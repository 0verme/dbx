...
<Steps>
  ...
  <Step>### Select Connections Choose one or more connections. All connections are selected by default. Only the selected connections, their sidebar groups, and referenced tunnel profiles are exported.</Step>
...
<Steps>
  ...
  <Step>### Done Only the selected connections are imported, with passwords restored. Deduplicated by name + host + port. Sidebar groups for the selected connections can still be applied after import.</Step>
</Steps>
